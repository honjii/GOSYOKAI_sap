...
!(function (t, e) {
    ...
    function O(t, e, n, i, s, a, o) {
        return (
            (t.a = e), (t.b = n), (t.c = i), (t.d = s), (t.e = a), (t.f = o), t
        );
    }
    var g,
        f,
    ...
    function Da(t) {
        (a = t.touches && _dragCount < t.touches.length),
            Ba(t.target, "touchend", Da);
    }
    function Ea(t) {
        (a = t.touches && _dragCount < t.touches.length),
            Aa(t.target, "touchend", Da);
    }
    function Fa(e, n) {
        return function (t) {
            return e.call(n, t);
    ...
    function Ma(t) {
        ...
        if (i._enabled && !a && i.isPressed && t) {
            ...
            } else if (t.pointerId && i.touchID && t.pointerId !== i.touchID)
                return;
            ma(s),
                i.setPointerPosition(t.pageX, t.pageY),
                i.vars.onDrag &&
                    i.vars.onDrag.call(
                        i.vars.callbackScope || i,
                        i.pointerEvent
                    );
        }
    }
        ...
        if (
            ...
            if (
                ...
                o
                    ? (n.isDragging = !1)
                    : n.vars.onClick &&
                      n.vars.onClick.call(n.vars.callbackScope || n, a),
                t)
            ) {
                if (
                    (i = t.changedTouches) &&
                    ...
                    (this.pointerX = t),
                        ...
                        (this.x === s && this.y === a) ||
                            ...
                            !this.isDragging &&
                                this.isPressed &&
                                ((this.isDragging = !0),
                                Ga("onDragStart", this, this.pointerEvent)));
                }),
        ...
        ut =
            ...
            (dt.init = function init() {
                ...
                if (((this._rawPath = i), a)) {
                    ...
                    for (e = this._anchors.length; -1 < --e; )
            ...
            (dt.select = function select(t) {
                ...
                return (
                    -1 === rt.indexOf(this) && rt.push(this),
                    this._updateAnchors(),
                    this
                );
            }),
            ...
            (dt._onPressAnchor = function _onPressAnchor(t) {
                -1 === this._selectedAnchors.indexOf(t)
                    ? (G || (this._selectedAnchors.length = 0),
            ...
            (dt._deleteSelectedAnchors = function _deleteSelectedAnchors() {
                for (
                    var t, e, n, i = this._selectedAnchors, s = i.length;
                    -1 < --s;
                ...
                return (
                    ...
                    t
                        ? this._selection.parentNode ||
                          ...
                          this._saveState())
                        : (this.deselect(),
                          this.path.ownerSVGElement.removeChild(
                              this._selectionHittest
                          ),
                          this.path.ownerSVGElement.removeChild(
                              this._selection
                ...
                if (
                    ...
                    r &&
                        ...
                        (e || r.isClosedStart) &&
                            ((i =
                                n[
                                    (a = r.isClosedStart ? n.length - 4 : e - 2)
                                ]),
                            (s = n[1 + a]),
                            this._handle1.setAttribute(
                                "transform",
            ...
            (dt.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
                var s,
                    ...
                    f = -t || c[g - 1] + u;
                for (
                    f = f ? 1 / f : -p, p *= 1e3, f *= 1e3, a = at.length = 0;
                    a < g;
                    a += 2
                )
                    (at[a] = (((c[a] + d) * p) | 0) / 1e3),
    ...
    function PathEditor(t, e) {
        (e = e || {}),
            ...
            (this._g = oa("g", this.path.ownerSVGElement, {
        ...
        !1 !== e.draggable &&
            ...
            h ||
                (Aa(
                    this._selectionHittest,
                    "mousedown",
                    Fa(this._onClickSelectionPath, this)
                ),
                Aa(
                    this._selectionHittest,
                    "mouseup",
                    Fa(this._onRelease, this)
                )),
            Aa(
                this._selectionHittest,
                "touchstart",
    ...
    (ut.simplifyPoints = simplifyPoints),
        ...
        (ut.simplifySVG = function (t, e) {
            ...
            if (
                ...
                (c = e.precision || 1 / d),
                (g =
                    (void 0 === e.cornerThreshold ? 18 : +e.cornerThreshold) *
                    J),
                ...
                (i = pointsToSegment(simplifyPoints(i, d), e.curviness, g))[2] =
                    "C" + i[2];
                ...
                function (t) {
                    ...
                    (u && a < h) || (i = a - h) * i < r
                        ...
                        p &&
                            ...
                            s * s < r && (o = p.y)),
                        f &&
                            (i = (e = h + Math.round((a - h) / f) * f) - a) *
                                i +
                                (s =
                                    (n = l + Math.round((o - l) / f) * f) - o) *
                                    s <
                                r &&
                            ((a = e), (o = n)),
                        (t.x = a),
        ...
        (pt = window),
            ...
            (bt = gt && gt.plugins.motionPath)
                ? ((function _initCopyToClipboard() {
                      ((At = gb("textarea")).style.display = "none"),
                          mt.appendChild(At);
                  })(),
        ...
        St =
            ((function (t) {
                var e =
                        ...
                        -1 !==
                            t.indexOf(
                                bb(108, 111, 99, 97, 108, 104, 111, 115, 116)
                            ) ||
                        -1 !==
                            t.indexOf(bb(49, 50, 55, 46, 48, 32, 48, 46, 49)),
                    n = [
                        wt,
        ...
        t instanceof gt.core.Tween
            ...
            : ((n = gt.utils.toArray(t)[0]),
              (l = (function _findMotionPathTween(t) {
                  for (var e = gt.getTweensOf(t), n = 0; n < e.length; n++) {
                      ...
                      e[n].timeline &&
                          e.push.apply(e, e[n].timeline.getChildren());
                  }
              })(n))),
            (i = mb(e.path, n, e)),
            (this.offset = m),
            (r = (function _getPositionOnPage(t) {
                var e = t.getBoundingClientRect(),
                    n =
                        _t.clientTop -
                        (pt.pageYOffset || _t.scrollTop || mt.scrollTop || 0),
                    i =
                        _t.clientLeft -
                        (pt.pageXOffset || _t.scrollLeft || mt.scrollLeft || 0);
                return {
                    left: e.left + i,
                    top: e.top + n,
                    right: e.right + i,
                ...
                s
                    ? ((h = n.ownerSVGElement),
                      ...
                      (a = (u = (function _getConsolidatedMatrix(t) {
                          return (t.transform.baseVal.consolidate() || Ct)
                              .matrix;
                      })(n)).e),
                      (o = u.f),
                      (m.x = d.x),
